...
<div class="skin_top"><!--skin_top begin-->
	...
	<div class="top_mid"><!--top_mid begin-->
		...
		<div class="zjxq_input fl"><!--zjxq_input begin-->
			...
			<div class="error hidden"><p>请输入完整信息信息</p></div>
		...
		<div class="dy fr"><div class="error hidden">请输入完整信息</div><p class="l"></p><span><input name="" type="text" /></span><a href="#">订阅</a></div>
