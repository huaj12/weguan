...
public class WheelView extends View {
	 ...
	 *            the listener
	 */
	public void setChangingListener(OnWheelChangedListener listener) {
	...
	public <T> void setArrayAdapter(List<T> datas, int itemIndex, int length) {
		this.setAdapter(new ArrayWheelAdapter<T>(datas, length));
		this.setCurrentItem(itemIndex);
	}

	public void setNumericAdapter(int minValue, int maxValue, int itemIndex,
			int length) {
		this.setAdapter(new NumericWheelAdapter(minValue, maxValue, length));
		this.setCurrentItem(itemIndex);
	}
