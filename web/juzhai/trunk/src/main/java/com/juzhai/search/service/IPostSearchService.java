...
public interface IPostSearchService {
	 ...
	 * @return
	 */
	List<Post> queryPosts(String content,String place,Date startDate,Date endDate,long categoryId,int firstResult,
			int maxResults);
	/**
	 * 建索引
	 * 
