package com.google.gdata.v2.provider;
...
public class OAuthDoubanProvider {
	...
	static final private Logger logger = Logger
			.getLogger(OAuthDoubanProvider.class.getName());

	public OAuthDoubanProvider() {
	}

	public OAuthDoubanProvider(String apiKey, String secretKey) {
		this.apiKey = apiKey;
	...
	public AccessToken tradeAccessTokenWithCode(String code)
