...
public class ShareTokenTest {
    ...
    @Test
    public void testAddShare() throws IOException, InvalidKeyException, NoSuchAlgorithmException {
        ...
        shares.put("url", "http://www.b3log.org/?time=" + System.currentTimeMillis());
        shares.put("images", "http://www.b3log.org/images/logo.png)?time=" + System.currentTimeMillis());
        
        final String html = new ShareToken().addShare(oauth_token, oauth_token_secret, openid, "xml", shares);
