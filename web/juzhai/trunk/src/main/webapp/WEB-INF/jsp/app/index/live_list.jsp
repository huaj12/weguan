...
<ul>
	<c:forEach var="actLiveView" items="${actLiveViewList}">
		<li onmouseover="javascript:mouseHover(this, true);" onmouseout="javascript:mouseHover(this, false);">
			...
			<strong>
				<c:import url="/WEB-INF/jsp/app/common/fragment/user_city.jsp">
					<c:param name="cityId" value="${actLiveView.profileCache.city}"/>
				</c:import>&nbsp;&nbsp;<c:set var="date" value="${actLiveView.time}" scope="request"/><c:import url="/WEB-INF/jsp/app/common/fragment/show_time.jsp" />
			</strong>
		</li>
	</c:forEach>
</ul>
