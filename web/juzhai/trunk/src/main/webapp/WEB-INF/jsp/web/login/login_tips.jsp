			...
			<span>
				...
				<c:choose>
					<c:when test="${not empty isQplus&&isQplus}">
						<a href="javascript:void(0);" title="使用QQ账号登录" go-uri="/qplus/loginDialog/9" class="login-btn"><img src="${jzr:static('/images/web2/qq_login_btn.gif')}" /></a>	
					</c:when>
					<c:otherwise>
						<a href="javascript:void(0);" title="使用QQ账号登录" go-uri="/web/login/8" class="login-btn"><img src="${jzr:static('/images/web2/qq_login_btn.gif')}" /></a>
					</c:otherwise>
				</c:choose>
			</span>
