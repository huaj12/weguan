...
public class ProfileContrller extends BaseController {
	...
	protected void assembleCitys(Model model) {
		model.addAttribute("towns",
				com.juzhai.common.InitData.TOWN_MAP.values());
		model.addAttribute("citys",
				com.juzhai.common.InitData.CITY_MAP.values());
		model.addAttribute("provinces",
				com.juzhai.common.InitData.PROVINCE_MAP.values());
	}
