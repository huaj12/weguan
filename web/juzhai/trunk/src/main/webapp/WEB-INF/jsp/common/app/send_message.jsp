...
<div id="aboutDiv" style="display: none">
	<div class="cantact_user">
		...
		<div class="clear"></div>
		<div  id="about_btn" class="bt">
			<a href="javascript:;" onclick="sendAbout();">发送</a>
		</div>
			<div class="sending" id="about_btn_sending" style="display: none">
				<!--sending begin-->
		...
		<div class="ck">
			<c:if test="${context.tpName=='weibo'}">
				...
				<p>
					<em><input name="wb" id="type_weibo" type="checkbox" value="1" />
					</em><span>微薄</span>
				</p>
				<p>
			...
			<input id="about_fid" value="" type="hidden" /> <input
				id="about_name" value="" type="hidden" /> <input id="about_actId"
				value="" type="hidden" />
