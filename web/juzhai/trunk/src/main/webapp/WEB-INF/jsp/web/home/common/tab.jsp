...
<div class="user_menu"><!--user_menu begin-->
	...
	<a href="/home/interests/1" <c:if test="${tabType=='interests'}">class="active"</c:if>>我感兴趣的人(${interestCount})</a>
	<a href="/home/datings/1" <c:if test="${tabType=='datings'}">class="active"</c:if>>我约的人(${datingCount})</a>
	<a href="/home/interestMes/1" <c:if test="${tabType=='interestMes'}">class="active"</c:if>>对我感兴趣的人(${interestMeCount})</a>
