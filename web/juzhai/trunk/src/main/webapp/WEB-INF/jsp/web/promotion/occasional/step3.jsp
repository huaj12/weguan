	...
	<c:when test="${not empty profile && not empty content}">
		<div class="sen_area"><!--sen_area begin-->
			<div class="sen4"><!--sen1 begin-->
				<div class="photo"><a href="http://www.51juzhai.com"><img src="${jzr:userLogo(profile.uid,profile.logoPic,180)}" /></a></div>
				<div class="photo_right">
					<p>不久后，你会在<b>${content}</b>偶遇ta</p>
				</div>
				<div class="logo"><a href="http://www.51juzhai.com">去拒宅网偶遇更多&gt;&gt;</a></div>
			</div><!--sen1 end-->
		</div><!--sen_area end-->
	</c:when>
	<c:otherwise>
