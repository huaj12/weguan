...
public class AccessToken {
    ...
    public String getAccessToken(String oauth_token, String oauth_token_secret, String oauth_vericode) throws IOException,
        ...
        parameters.add(new BasicNameValuePair(OAuth.OAUTH_VERICODE, oauth_vericode));
