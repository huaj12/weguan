			...
			<c:when test="${feed.feedType=='QUESTION'}">
				...
				<div class="df fl"><!--infor begin-->
					...
					<div class="star"><!--star begin-->
						<span class="link" onmouseover="javascript:holdStar(1);" onmouseout="javascript:holdStar(-1);" onclick="javascript:answer(1, '${feed.tpFriend.userId}', ${times});" title="有点宅"></span>
						<span class="link" onmouseover="javascript:holdStar(2);" onmouseout="javascript:holdStar(-1);" onclick="javascript:answer(2, '${feed.tpFriend.userId}', ${times});" title="比较宅"></span>
						<span class="link" onmouseover="javascript:holdStar(3);" onmouseout="javascript:holdStar(-1);" onclick="javascript:answer(3, '${feed.tpFriend.userId}', ${times});" title="比我宅"></span>
						<span class="link" onmouseover="javascript:holdStar(4);" onmouseout="javascript:holdStar(-1);" onclick="javascript:answer(4, '${feed.tpFriend.userId}', ${times});" title="很宅"></span>
						<span class="link" onmouseover="javascript:holdStar(5);" onmouseout="javascript:holdStar(-1);" onclick="javascript:answer(5, '${feed.tpFriend.userId}', ${times});" title="相当宅"></span>
					</div><!--star end-->
...
<div class="bot"></div>
<c:if test="${feed!=null&&feed.feedType=='QUESTION'}">
	<div class="next_btn"><a href="#" onclick="javascript:answer(0, '${feed.tpFriend.userId}', ${times});">跳  过</a></div>
</c:if>