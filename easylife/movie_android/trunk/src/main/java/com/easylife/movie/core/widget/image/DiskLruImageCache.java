...
public class DiskLruImageCache {
	...
	private boolean writeBitmapToFile(boolean hasPng, Bitmap bitmap,
	...
	private File getDiskCacheDir(Context context, String uniqueName) {
		...
		final File cacheFile = (Environment.MEDIA_MOUNTED.equals(Environment
		...
		if (BuildConfig.DEBUG) {
			Log.d("cache_test_DISK_", "final path: " + cachePath);
		}
		if (null == cachePath) {
	...
	public void put(boolean hasPng, String key, Bitmap data) {
		...
		try {
			...
			if (writeBitmapToFile(hasPng, data, editor)) {
				editor.commit();
				mDiskCache.flush();
				if (BuildConfig.DEBUG) {
