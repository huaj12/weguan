...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
			<title>好主意收藏 拒宅网-助你找伴儿出去玩(51juzhai.com)</title>
	...
	<body>
		<div class="warp"><!--warp begin-->
						...
						<div class="content_box w660 800"><!--content begin-->
							...
							<div class="m">
								<div class="my_index"><!--my_index begin-->
									<c:set var="tabType" value="interestIdea" scope="request"/>
									<jsp:include page="../common/new_tab.jsp" />
									<jsp:include page="interestIdea_list.jsp" />
								</div><!--my_index end-->
							</div>
							<div class="t"></div>
						</div><!--content end-->
			...
			<script type="text/javascript" src="${jzr:static('/js/web/home_visitors.js')}"></script>
