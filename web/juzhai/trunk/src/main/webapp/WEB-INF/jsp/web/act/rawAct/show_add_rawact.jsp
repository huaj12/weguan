...
<body>
					...
					<div class="tj_project">
						...
						<div class="tj_main">
							...
							<div class="xhang">
								...
								<div class="input">
									<p class="l"></p>
									<span class="w190"><input name="name" id="name"
										type="text" /> </span>
									<p class="r"></p>
								</div>
							...
							<div class="xhang">
								...
								<div class="upload">
									...
									<div class="load_done" style="display: none;">
										<!--load_done begin-->
										<p>
											<img id="logo" src="" width="180" height="180" />
										</p>
							...
							<div class="xhang">
								...
								<div class="select">
									...
									</span> <span id="towns"><select name="town" id="town">
	...
	<script type="text/javascript"
		src="${jzr:static('/js/web/raw_act.js')}"></script>
	<script type="text/javascript"
	...
	<c:if test="${success}">
		<script type="text/javascript">
			$(document).ready(
					function() {
						var content = $("#dialog-success").html().replace(
								"{0}", "谢谢推荐，通过审核后立即发布!");
