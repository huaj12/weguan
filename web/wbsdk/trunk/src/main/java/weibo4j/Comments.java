...
public class Comments extends Weibo {
	...
	private static final long serialVersionUID = -5388633985171995301L;

	public Comments(String token) {
		super(token);
	}
	...
	public List<Comment> getCommentById(String id) throws WeiboException {
		return Comment.constructComments(client.get(
	 ...
	 * @since JDK 1.5
	 */
	public List<Comment> getCommentById(String id, Paging page, Integer count,
	...
	public List<Comment> getCommentByMe() throws WeiboException {
		return Comment.constructComments(client.get(WeiboConfig
	 ...
	 * @since JDK 1.5
	 */
	public List<Comment> getCommentByMe(Paging page, Integer filter_by_source)
			throws WeiboException {
		return Comment.constructComments(client.get(
	 ...
	 * @since JDK 1.5
	 */
	public List<Comment> getCommentToMe(Paging page, Integer filter_by_source,
			Integer filter_by_author) throws WeiboException {
		return Comment.constructComments(client.get(
				...
				new PostParameter[] {
						new PostParameter("filter_by_source", filter_by_source
								.toString()),
						new PostParameter("filter_by_author", filter_by_source
								.toString()) }, page));
	}
	 ...
	 * @since JDK 1.5
	 */
	public List<Comment> getCommentMentions(Paging page,
	...
	/**
	 * 回复一条评论 s * @param comment 评论内容，必须做URLencode，内容不超过140个汉字
	 * 
	 * @param cid
	 *            需要回复的评论ID
	 * @param id
	...
	public List<Comment> destoryCommentBatch(String ids) throws WeiboException {
		return Comment
				.constructComment(client.post(WeiboConfig.getValue("baseURL")
