...
<div class="cqw_item_list"><!--cqw_item_list begin-->
	<c:forEach var="categoryActView" items="${categoryActViewList}">
		<div class="cqw_item mouseHover"><!--cqw_item begin-->
			<div class="more"><a href="/act/${categoryActView.act.id}" title="点击进入"></a></div>
			<div class="photo">
			...
			<div class="dh_infor"><!--dh_infor begin-->
				...
				<c:if test="${not empty categoryActView.act.address}">
					<h3 class="place"><strong>地点:</strong>${jzd:cityName(categoryActView.act.city)}${jzd:townName(categoryActView.act.town)}${categoryActView.act.address}</h3>
				</c:if>
