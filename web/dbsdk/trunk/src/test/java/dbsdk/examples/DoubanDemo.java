...
public class DoubanDemo {
	...
	public static void main(String[] args) {
		String apiKey = "00fb7fece2b96fd202f27fc6a82c4f76";
		String secret = "a1041f198d4f46f9";

		DoubanService myService = new DoubanService("51juzhai", apiKey,
				secret);
	...
	private static void testMiniblogEntry(DoubanService myService) {
		...
		try {
			...
			myService.createSaying(new PlainTextConstruct(
					"Hello Douban API java client!"));
		} catch (IOException e) {
			e.printStackTrace();
	...
	private static void printMiniblogEntry(MiniblogEntry me) {
		...
		System.out.println("title is " + me.getTitle().getPlainText());
	...
	private static void printNoteEntry(NoteEntry noteEntry) {
		...
		System.out.println("title is " + noteEntry.getTitle().getPlainText());
		/*
	...
	private static void testWriteNoteEntry(DoubanService myService) {
		...
		try {
			String content = "立春立春立春立春立春立春立春立春立春立春立春立春立春立春立春立春立春立春立春立春立春立春立春立春立春立春立春立春立春立春立春立春立春立春立春立春立春立春立春立春立春立春立春立春立春立春立春立春立春立春立春立春立春立春立春立春";
			noteEntry = myService.createNote(new PlainTextConstruct("立春"),
			...
			myService.updateNote(noteEntry, new PlainTextConstruct("立秋"),
					new PlainTextConstruct(content2), "public", "no");
