package com.juzhai.android.core.widget.list.table.widget;
...
public class UITableView extends LinearLayout {
	...
	public UITableView(Context context, AttributeSet attrs) {
		...
		mMainContainer = (LinearLayout) mInflater.inflate(
				R.layout.uitable_list_container, null);
	...
	public void commit() {
		...
		if (mItemList.size() > 1) {
			...
			for (IListItem obj : mItemList) {
				...
				if (mIndexController == 0) {
					tempItemView = mInflater.inflate(
							R.layout.uitable_list_item_top, null);
				} else if (mIndexController == mItemList.size() - 1) {
					tempItemView = mInflater.inflate(
							R.layout.uitable_list_item_bottom, null);
				} else {
					tempItemView = mInflater.inflate(
							R.layout.uitable_list_item_middle, null);
				}
			...
			View tempItemView = mInflater.inflate(
					R.layout.uitable_list_item_single, null);
