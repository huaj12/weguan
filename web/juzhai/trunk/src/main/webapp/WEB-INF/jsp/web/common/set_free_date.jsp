...
<div class="float_box" id="freeDateForm" <c:if test="${freeDateFormHide!=null&&freeDateFormHide}">style="display:none;"</c:if>><!--float_box begin-->
	<div class="width960"><!--width960 begin-->
		<p></p>
		<div class="con"><!--con begin-->
			<div class="close"><a href="javascript:void(0)" onclick="javascript:$('#freeDateForm').fadeOut(500);"></a></div>
