...
import com.juzhai.dpsdk.model.MySSLSocketFactory;
...
public class HttpClient implements java.io.Serializable {
	...
	public HttpClient() {
		...
		this(150, Configuration.getConnectionTimeout(), Configuration
				.getReadTimeout(), 1024 * 1024);
	}
	...
	public Response get(String url) throws DianPingException {
	...
	public Response post(String url, PostParameter[] params,
			Boolean WithTokenHeader) throws DianPingException {
		log("Request:");
		log("POST" + url);
	...
	public Response multPartURL(String fileParamName, String url,
		...
		try {
			...
			throw new DianPingException(ex.getMessage(), ex, -1);
		}
	}

	public Response httpRequest(HttpMethod method) throws DianPingException {
	...
	public Response httpRequest(HttpMethod method, Boolean WithTokenHeader)
		...
		try {
			...
			{
				try {
					throw new DianPingException(getCause(responseCode),
			...
			throw new DianPingException(ioe.getMessage(), ioe, responseCode);
		} finally {
	...
	private String getSign(PostParameter[] params) {
		...
		stringBuilder.append(getAppSecret());
