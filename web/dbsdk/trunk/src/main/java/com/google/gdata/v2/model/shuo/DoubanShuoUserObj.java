package com.google.gdata.v2.model.shuo;
...
public class DoubanShuoUserObj implements IDoubanObject {
	...
	/**
	 * @param totalStatusCount
	 *            the totalStatusCount to set
	 */
