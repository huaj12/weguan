...
public class HomeSettingActivity extends NavigationActivity {
	private IUserViewHelper userViewHelper = new UserViewHelper();
	private UITableView logoTableView;
	...
	private void logoList() {
		...
		userViewHelper.showUserLogo(HomeSettingActivity.this, user,
				userLogoView, 35, 35);
	...
	private void infoList() {
			...
			public void onClick(int index) {
				if (index == 0) {
					...
					DatePickerDialog dlg = new DatePickerDialog(
							HomeSettingActivity.this, new OnDateSetListener() {
								@Override
							...
							}, user.getBirthYear(), user.getBirthMonth() - 1,
							user.getBirthDay());
					dlg.show();
				}
			}
		...
		infoTableView.addBasicItem(getResources().getString(R.string.gender),
				JzUtils.getGender(user.getGender(), HomeSettingActivity.this),
				ItemType.HORIZONTAL);
		...
		if (requestCode == ActivityCode.RequestCode.PIC_REQUEST_CODE
			...
			if (logo != null) {
				...
				userLogoView.setImageBitmap(ImageUtils.zoomBitmap(logo,
						UIUtil.dip2px(HomeSettingActivity.this, 35),
						UIUtil.dip2px(HomeSettingActivity.this, 35)));
				finish.setEnabled(true);
			} else {
