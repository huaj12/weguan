...
public class RedisKeyGenerator extends KeyGenerator {
	 ...
	 * @return
	 */
	public static String genUserNoticeNumKey(long uid, int noticeType) {
		return genKey(uid, noticeType + "_noticeNum");
	}
	 ...
	 * @return
	 */
	public static String genUserSubNoticeKey(long uid, int noticeType) {
		return genKey(uid, noticeType + "_emailSub");
	}
