...
<div class="photo fl"><img src="images/pic.png"  width="80" height="80"/></div>
...
<strong><fmt:formatDate value="${actMsg.act.createTime}" pattern="yyyy.MM.dd HH:mm"/></strong></div><!--infor end-->
