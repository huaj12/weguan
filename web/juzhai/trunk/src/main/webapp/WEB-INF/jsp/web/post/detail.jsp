...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>${postProfile.nickname}:<c:out value="${jzu:truncate(post.content, 30, '...')}" />_拒宅网</title>
		<meta  name="keywords"   content="拒宅,找伴,出去玩,约会,交友" />
		<meta  name="description"   content="${postProfile.nickname}:<c:out value="${jzu:truncate(post.content, 30, '...')}" />_不想宅在家,找伴儿,出去玩,发现出去玩的好主意和同兴趣的朋友,促成约会" />
