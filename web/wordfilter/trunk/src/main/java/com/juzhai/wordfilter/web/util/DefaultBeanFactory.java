 ...
 * 
 * <pre>
 * 使用SingletonBeanFactoryLocator获取Bean，使用缺省的配置文件beanRefFactory.xml，初始化ApplicationContext。
 * 默认的ApplicationContext名字为default。 
 * 详见SingletonBeanFactoryLocator javadoc:
 ...
 * </p>
 * <p>
 * Company: LINKTONE. @author bing.xie
 * </p>
 * 
 * @version 1.0
 */
public class DefaultBeanFactory {
	...
	protected final static BeanFactory getFactory(String ctxName) {
		BeanFactoryLocator beanFactoryLocator = selector == null ? SingletonBeanFactoryLocator
				.getInstance() : SingletonBeanFactoryLocator
