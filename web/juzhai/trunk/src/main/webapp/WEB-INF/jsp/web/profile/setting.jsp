					...
					<div class="set">
						...
						<div class="set_right">
							...
							<div class="my_infor">
								...
								<div class="face">
									<!--face begin-->
									<p><img src="${jzr:userLogo(profile.uid,profile.newLogoPic,180)}" /><c:choose><c:when test="${profile.logoVerifyState == 1}"><b>审核中...</b></c:when><c:when test="${profile.logoVerifyState == 3}"><b>未通过审核</b></c:when></c:choose></p>
									...
									<div class="infor_x">
										...
										<div class="select">
											...
											<span><select id="province"
												...
												name="town" id="town">
													<option
																<c:if test="${profile.town==0}">selected="selected"</c:if>
																value="0">其他</option>
