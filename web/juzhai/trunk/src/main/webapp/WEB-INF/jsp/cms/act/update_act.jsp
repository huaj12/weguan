...
<body>
	<h2>修改项目&nbsp;<font color="red">${errorInfo}</font></h2>
	<form action="/cms/updateAct" onsubmit="return checkData();" method="post" enctype="multipart/form-data">
		...
		<table>
			...
			<tr>
				<td>logo</td>
				<td><img src="${logoWebPath}" width="50" height="50" />重新上传<input type="file" name="imgFile" /></td>
			</tr>
			<tr>
