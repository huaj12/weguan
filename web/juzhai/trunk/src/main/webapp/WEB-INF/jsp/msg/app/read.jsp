...
<div class="integral"><p>积分:${point}</p><a href="#" onclick="dialogSysnews();"></a></div>
...
<a href="/msg/showUnRead.html" class="link new"><p class="l"></p><span><em class="mail"></em><strong>未读(${unReadCount})</strong></span><p class="r"></p></a>

<a href="/msg/showRead.html" class="active"><p class="l"></p><span><em class="mail_open"></em><strong>已读(${pager.totalResults})</strong></span><p class="r"></p></a></div><!--tab end-->
...
<span class="l"></span><span class="r"></span><div class="close"><a  href="#" onclick="remove('${pager.currentPage}','${msg.index }','read')" ></a></div>

<div class="item_style1"><!--item_style1 begin-->

<div class="photo fl"><img src="${actMsg.profileCache.logoPic }"  width="80" height="80"/></div>
...
<span class="u">${actMsg.profileCache.nickname }</span>
	...
	<span class="w">想和你去</span><span class="v">${actMsg.act.name }</span>
	</c:when>
	<c:otherwise>
...
<strong><fmt:formatDate value="${actMsg.date}" pattern="yyyy.MM.dd HH:mm"/></strong></div><!--infor end-->
