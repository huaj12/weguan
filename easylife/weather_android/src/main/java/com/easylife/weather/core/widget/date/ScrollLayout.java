...
import com.easylife.weather.core.widget.date.labeler.Labeler;
import com.easylife.weather.core.widget.date.timeview.TimeView;
...
public class ScrollLayout extends LinearLayout {
	...
	public ScrollLayout(Context context, AttributeSet attrs) {
		...
		objGravity = a.getInt(R.styleable.ScrollLayout_android_gravity,
				Gravity.CENTER);
	...
	private void setTime(long time, int loops) {
		...
		if (loops > 2 || currelem.getStartTime() <= time
			...
			if (loops > 2) {
				Log.w("ABC", String.format(
						"LOOPOVERLFOW: time: %d, start: %d, end: %d", time,
