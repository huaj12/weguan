		...
		<div class="select_menu" name="purposeType"><!--select_menu begin-->
			...
			<div class="select_box"><!--select_box begin-->
				<span>
					...
					<a href="javascript:void(0);" value="2" <c:if test="${postForm.purposeType == 2}">class="selected"</c:if>>我想和一个男生</a>
					<a href="javascript:void(0);" value="3" <c:if test="${postForm.purposeType == 3}">class="selected"</c:if>>我想和一个女生</a>
				</span>
				<em></em>
			</div><!--select_box end-->
		</div><!--select_menu end-->
