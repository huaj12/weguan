...
<div class="pro_box"><p>请输入正确的邮件格式!</p></div>

<div class="integral"><p>积分:${point}</p><a href="#"></a></div>
...
<a href="/msg/showUnRead.html" class="active new"><p class="l"></p><span><em class="mail"></em><strong>未读(${pager.totalResults})</strong></span><p class="r"></p></a>

<a href="/msg/showRead.html" class="link"><p class="l"></p><span><em class="mail_open"></em><strong>已读(${readCount})</strong></span><p class="r"></p></a></div><!--tab end-->


<!--pbr begin-->
<!-- div class="pbr">

<a href="#">被我屏蔽的人</a></div><!--pbr end-->
...
<div class="box_body"><!--box_body begin-->
 <c:forEach var="actMsg" items="${actMsgViewList}" varStatus="msg">
	...
	<span class="l"></span><span class="r"></span><div class="close"><a  href="#" onclick="remove('${pager.currentPage}','${msg.index }','unread')"><img src="images/close.png" /></a></div>
	...
	<div class="clear"></div>
	<p>他在${citys[actMsg.profileCache.city]}</p><a href="#" title="需消耗20积分" onclick="javascrpit:openmsg('${pager.currentPage}','${msg.index }');" class="view">立即查看</a><strong>需消耗20积分</strong><em><fmt:formatDate value="${actMsg.act.createTime}" pattern="yyyy.MM.dd HH:mm"/></em></div><!--infor end-->
	</div><!--item_style2 end-->
...
在我的消息中立即响应 +10分<br>
在我的消息主动联系对方 +10分</p>
<a href="#" onclick="closeAllDiv();" class="iknow">知道了</a></div><!--box_mid end-->
