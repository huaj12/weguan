...
<c:set var="values" value="发布拒宅数|发布好主意数|通过审核拒宅数|感兴趣数,本地注册数|注册数|q+注册数|通过审核头像数|完成引导数,点击解救小宅数|拒宅留言数|响应拒宅数|私密约数|打开好主意弹框数|私信总数|点击解救女宅数|解救女宅框数|收藏用户数|解救小宅弹框数,登陆数|本地登录数|打开邮件数|通过邮件回访数|宅男自救器开启人数|宅男自救器关闭人数|ios下载次数|android下载次数,iosQQ注册人数|ios豆瓣注册人数|ios微博注册人数|androidQQ注册人数|android豆瓣注册人数|android微博注册人数" />
<c:set var="value" value="${fn:split(values, delim)}"/>
<c:set var="names" value="行为统计,互动统计,转化率统计,其他统计,手机注册" />
