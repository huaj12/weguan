...
<div class="${footClass}"><!--bottom_welcome begin-->
	<div class="bottom_area">
		<c:choose>
			...
			<c:otherwise><p>拒宅网©2012&nbsp;<a href="http://www.miibeian.gov.cn/" target="_blank">沪ICP备11031778号</a></p><a href="http://weibo.com/51juzhai" target="_blank">官方微博</a><a href="javascript:void(0);" target-uid="3" target-nickname="拒宅妹妹" id="feedback" has-login="${context.uid > 0}">意见反馈</a><a href="/aboutUs">关于我们</a></c:otherwise>
		</c:choose>
	</div>
