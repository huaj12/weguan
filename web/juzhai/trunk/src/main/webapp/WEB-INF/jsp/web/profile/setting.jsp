						...
						<div class="set_right">
							...
							<div class="my_infor">
								...
								<div class="face">
									<!--face begin-->
									<p>
										<img src="${jzr:userLogo(profile.uid,profile.logoPic,120)}" />
									</p>
								...
								<div class="infor">
									...
									<div class="infor_x">
										...
										<div class="select" id="input_gender" style="display: none">
											...
											</select> </span> <a href="#" onclick="setGender();" class="ok">确定</a> <a href="javascript:void(0);" onclick="cancel_updateDiv('gender');"class="cancel">取消</a>
										</div>
										<!--select end-->
									...
									<div class="infor_x">
										...
										<!--select end-->
										<div class="input" id="profession_input" <c:if test="${profile.professionId!=0}">style="display: none"</c:if>>
											<!--input begin-->
											<p class="l"></p>
											<span class="w190"><input  id="profession" type="text"
												value="${profile.profession}"  onfocus="if(this.value=='10个字以内描述')this.value=''" onblur="if(this.value=='')this.value='10个字以内描述'" /> </span>
											<p class="r"></p>
									...
									<div class="infor_x">
										...
										<div class="input">
											<p class="l"></p>
											<span class="w90"><input name="feature" type="text" value="${f}" />
											</span>
											<p class="r"></p>
