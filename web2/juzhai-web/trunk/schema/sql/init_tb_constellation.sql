/*
-- Query: SELECT * FROM `juzhai`.`tb_constellation`
LIMIT 0, 1000

-- Date: 2012-02-14 16:12
*/
INSERT INTO `tb_constellation` (`id`,`name`,`start_month`,`start_date`,`end_month`,`end_date`) VALUES (1,'白羊座',3,21,4,19);
INSERT INTO `tb_constellation` (`id`,`name`,`start_month`,`start_date`,`end_month`,`end_date`) VALUES (2,'金牛座',4,20,5,20);
INSERT INTO `tb_constellation` (`id`,`name`,`start_month`,`start_date`,`end_month`,`end_date`) VALUES (3,'双子座',5,21,6,21);
...
INSERT INTO `tb_constellation` (`id`,`name`,`start_month`,`start_date`,`end_month`,`end_date`) VALUES (11,'水瓶座',1,20,2,18);
INSERT INTO `tb_constellation` (`id`,`name`,`start_month`,`start_date`,`end_month`,`end_date`) VALUES (12,'双鱼座',2,19,3,20);
