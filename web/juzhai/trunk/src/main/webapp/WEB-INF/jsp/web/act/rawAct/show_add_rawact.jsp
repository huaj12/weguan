	...
	<body>
		<div class="warp"><!--warp begin-->
			<div class="main"><!--main begin-->
						...
						<div class="tj_project"><!--tj_project begin-->
							...
							<div class="tj_main"><!--tj_main begin-->
								...
								<div class="xhang"><!--x_hang begin-->
									...
									<div class="upload"><!--upload begin-->
										...
										<form id="uploadImgForm" method="post" enctype="multipart/form-data">
											<input type="file" onchange="uploadImage();" name="rawActLogo" />
										</form>
								...
								<div class="xhang"><!--x_hang begin-->
										...
										<span id="towns"><select name="town" id="town">
											<c:forEach var="town" items="${towns}">
												<c:if test="${c==town.cityId}">
													<option <c:if test="${profile.town==town.id}">selected="selected"</c:if>
									...
									<div class="input">
										<p class="l"></p>
										<span class="w290"><input name="address" id="address" type="text" value="详细地址" onfocus="if(this.value=='详细地址')this.value=''" onblur="if(this.value=='')this.value='详细地址'" /> </span>
										<p class="r"></p>
									</div>
								...
								<div class="xhang"><!--x_hang begin-->
									...
									<div class="input"><!--select begin-->
										<span class="w190"><input name="startTime" readonly="readonly" id="startTime" onclick="WdatePicker()" type="text" /></span>
									</div><!--select end-->
									<b>到</b>
									<div class="input"><!--select begin-->
										<span class="w190"><input name="endTime" id="endTime" readonly="readonly" onclick="WdatePicker()" type="text" /></span>
									</div><!--select end-->
								</div><!--x_hang end-->
				...
				<div class="tj_done_show_box" id="tj_show_box" style="display: none"><!--tj_done_show_box begin-->
					<h2 id="tj_tip"></h2>
