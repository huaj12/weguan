...
import com.easylife.movie.setting.task.HistoryVideoListGetDataTask;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		listView.setOnRefreshListener(new OnRefreshListener2<ListView>() {
			...
			public void onPullDownToRefresh(
				...
				new HistoryVideoListGetDataTask(HistoryActivity.this, listView)
						.execute(1);
			}
		...
		listView.setAdapter(new VideoListAdapter(HistoryActivity.this));
