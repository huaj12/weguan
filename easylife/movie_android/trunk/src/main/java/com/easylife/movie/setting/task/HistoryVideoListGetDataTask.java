...
public class HistoryVideoListGetDataTask extends
		GetDataTask<VideoListResult, Video> {

	public HistoryVideoListGetDataTask(Context context,
	...
	protected VideoListResult doInBackground(Object... params) {
		...
		try {
			...
			result = videoService.getVideoHistoryListResult(context, page);
		} catch (Exception e) {
