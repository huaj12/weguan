		...
		<c:when test="${feed.feedType=='SPECIFIC'}">
			<div class="jz_box"><!--jz_box begin-->
				...
				<div class="infor fl data" data="{'friendId':${feed.profileCache.uid},'actId':${feed.act.id},'times':${times}}"><!--infor begin-->
					...
					<a href="javascript:;" class="want btn" onclick="javascript:response(1);" tip="将{0}加为我的兴趣，并找到同好好友" onmouseover="javascript:showTip(this, true, '${feed.act.name}');" onmouseout="javascript:showTip(this, false);" title="点击告诉ta"></a>
