...
<c:choose>
	<c:when test="${empty ideaViewList}">
		<div class="my_fav"><!--my_fav begin-->
			<div class="none">您还没有收藏</div>
		</div><!--my_fav end-->
	</c:when>
	<c:otherwise>
				...
				<div class="idea_box mouseHover"><!--pub_box begin-->
					...
					<div class="idea_box_m"><!--pub_box_m begin-->
						...
						<div class="fb_area"><!--fb_area begin-->
							...
							<div class="add_fav fav_del idea-un-interest" idea-id="${ideaView.idea.id}"><a href="javascript:void(0);">取消收藏</a></div>
						</div><!--fb_area end-->
					</div><!--pub_box_m end-->
					<div class="clear"></div>
